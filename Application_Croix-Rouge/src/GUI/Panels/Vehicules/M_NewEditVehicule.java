 ...
 * @author Greenlamp
 */
public class M_NewEditVehicule extends javax.swing.JPanel {
    ...
    public M_NewEditVehicule(Main parent, NetworkClientSSL socket, String titre) {
        initComponents();
        Ltitre.setText(titre);
        this.socket = socket;
        this.parent = parent;
        Vehicule vehicule = parent.getVehicule();
        if(vehicule != null){
            this.vehicule = new Vehicule(vehicule);
        }
    ...
    private void initComponents() {
        ...
        Gplaque = new javax.swing.JTextField();
        ...
        jLabel3.setText("Numéro de plaque du véhicule");
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Gplaque, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private javax.swing.JTextField Gplaque;
    ...
    private boolean checkChamp() {
        if(!EasyCheck.checkString(Gnom.getText())){
            ...
            Gnom.requestFocus();
            return false;
        }else if(!EasyCheck.checkString(Gplaque.getText())){
            parent.afficherMessage("Numéro de plaque invalide");
            Gplaque.requestFocus();
            return false;
        }
        return true;
    }
    ...
    private void remplirChamps() {
        Gnom.setText(vehicule.getNom());
        Gplaque.setText(vehicule.getNumeroPlaque());
    }

    private void enregistrerData() {
        String nom = Gnom.getText();
        String plaque = Gplaque.getText();
        PacketCom packet = null;
        if(vehicule == null){
            vehicule = new Vehicule();
        }
        vehicule.setNom(nom);
        vehicule.setNumeroPlaque(plaque);

        if(!edited){
            packet = new PacketCom(States.NEW_VEHICULE, (Object)vehicule);
        }else{
            Vehicule oldVehicule = parent.getVehicule();
            Vehicule[] data = {oldVehicule, vehicule};
            packet = new PacketCom(States.EDIT_VEHICULE, (Object)data);
        }
        socket.send(packet);
        try {
            ...
            Logger.getLogger(M_NewEditVehicule.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void traitementPacket(PacketCom retour) {
        ...
        boolean cont = false;
        if(type.equals(States.NEW_VEHICULE_OUI)){
            parent.afficherMessage("Nouveau véhicule ajouté avec succès");
            cont = true;
            ...
            parent.afficherMessage("Véhicule modifié avec succès");
            cont = true;
