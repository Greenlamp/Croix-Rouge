...
public class M_Identite extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Bprecedent, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void completerChampIdentite() {
        ...
        int jour = Integer.parseInt(new SimpleDateFormat("dd").format(dateNaissance));
        int mois = Integer.parseInt(new SimpleDateFormat("MM").format(dateNaissance));
        int annee = Integer.parseInt(new SimpleDateFormat("yyyy").format(dateNaissance));
